  ...
  <div v-if="librarySettings && machineSettings" class="settings-layout">
    ...
    <div class="settings-content">
      ...
      <template v-else-if="activeSection === 'canva'">
        ...
        >
          <v-alert type="info" variant="tonal" density="compact" class="mb-4">
            Create one integration in a church-controlled Canva Developer account. People at
            this church use the same integration; they do not each create their own.
          </v-alert>
        ...
        >
          <div class="remote-setting-row canva-callback-setting">
            <div class="remote-setting-copy">
              ...
              <span>
                Installed copies default to 47823 and portable copies to 47824. Change it only
                for a conflict, then register the new URL in Canva.
              </span>
